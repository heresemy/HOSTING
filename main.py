...
<html>
<head>
    <title>Dashboard - HOSTING VPS </title>
    <style>
...
<body>
    <div class="header">
        <div class="logo">⚡ HOSTING VPS </div>
        <div>
...
<html>
<head>
    <title>My Info - HOSTING VPS</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<html>
<head>
    <title>Admin Login - HOSTING VPS</title>
    <style>
        body {
            background: #050505;
            color: white;
...
<html>
<head>
    <title>Admin Dashboard - VPS L</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<body>
    <div class="header">
        <div class="logo">🛡️ VPS PANEL</div>
        <div class="nav">
...
<html>
<head>
    <title>Manage Users - HOSTING VPS</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<html>
<head>
    <title>All Bots - HOSTING VPS </title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
